...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create toodlipop-f8a0
  fly apps create toodlipop-f8a0-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app toodlipop-f8a0
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app toodlipop-f8a0-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly volumes create data --size 1 --app toodlipop-f8a0
  fly volumes create data --size 1 --app toodlipop-f8a0-staging
  ```
